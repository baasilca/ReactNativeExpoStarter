...
export default function Index(props) {
  ...
  const handleSearchClick = () => {
    const sortedCoffeeNames = CoffeeNames.sort((a, b) => a.name.localeCompare(b.name));
    console.log(sortedCoffeeNames);
  };
  ...
  return (
    <View style={styles.container}>
      <View style={{ flexDirection: 'column', justifyContent: 'flex-start', alignSelf: 'flex-start' }}>
        ...
        <Text style={{ color: 'white', fontWeight: "bold", fontSize: 20 }}>Mathikere, Bangalore</Text>
